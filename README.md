...
"run_one_element" simple example:  </br>  
python valid_XAS3Dabs_Ni_3d.py 99</br>
"run_Ni50FeCoCuZn" Data Experiment to Verify the Enhancement of XAS Predictive Capability for Ni-Deficient Samples by FeCoCuZn-Containing Samples:  </br>  
python valid_XAS3Dabs_Ni_3d.py 99</br>
"run_energyrange" prexanesmodel using two XAS3D model for two pre-edge feature and XANES prediction:  </br>  
python valid_prexanes.py 99</br>
"run_MOE" MOE multi-expert model using XAS3D as module:  </br>  
